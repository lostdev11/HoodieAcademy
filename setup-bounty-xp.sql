-- Hoodie Academy Bounty XP System Setup Script
-- Run this script in your Supabase SQL editor to set up the bounty XP system
...
-- Success message
SELECT 'Bounty XP System setup complete! 🎯' as status; 