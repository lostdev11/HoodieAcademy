...
import { LineChart, ArrowLeft, CheckCircle, XCircle, Award, AlertTriangle, Wallet, ChevronDown, ChevronUp, Home, ArrowRight, LockKeyhole } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
      ...
      <div className="w-full max-w-4xl mb-8 relative">
        ...
        <header className="text-center pt-16 md:pt-8">
           <h1 className="text-4xl md:text-5xl font-bold text-orange-400 mb-2">
            Technical Analysis Tactics: Chart Your Course
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground">
            Master chart patterns, indicators, and leverage trading to earn the 'Chart Commander' NFT badge.
          </p>
        </header>
      </div>
