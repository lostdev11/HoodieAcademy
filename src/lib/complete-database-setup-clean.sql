-- Complete Database Setup for Hoodie Academy (Clean Version)
...
-- Create indexes for users (IF NOT EXISTS)
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Users can view all bounty submissions" ON bounty_submissions;
DROP POLICY IF EXISTS "Users can insert their own bounty submissions" ON bounty_submissions;
DROP POLICY IF EXISTS "Admins can update bounty submissions" ON bounty_submissions;
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "Anyone can view retailstar rewards" ON retailstar_rewards;
DROP POLICY IF EXISTS "Admins can manage retailstar rewards" ON retailstar_rewards;
DROP POLICY IF EXISTS "Users can view their own retailstar rewards" ON user_retailstar_rewards;
DROP POLICY IF EXISTS "Admins can manage user retailstar rewards" ON user_retailstar_rewards;
DROP POLICY IF EXISTS "Anyone can view retailstar tasks" ON retailstar_tasks;
DROP POLICY IF EXISTS "Admins can manage retailstar tasks" ON retailstar_tasks;
...
DROP POLICY IF EXISTS "Admins can manage task completions" ON user_task_completions;
...
DROP TRIGGER IF EXISTS update_bounty_submissions_updated_at ON bounty_submissions;
DROP TRIGGER IF EXISTS update_user_xp_updated_at ON user_xp;
DROP TRIGGER IF EXISTS update_retailstar_rewards_updated_at ON retailstar_rewards;
DROP TRIGGER IF EXISTS update_user_retailstar_rewards_updated_at ON user_retailstar_rewards;
DROP TRIGGER IF EXISTS update_retailstar_tasks_updated_at ON retailstar_tasks;
DROP TRIGGER IF EXISTS update_user_task_completions_updated_at ON user_task_completions;
