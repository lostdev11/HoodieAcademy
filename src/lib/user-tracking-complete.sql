-- Complete User Tracking System - Views and Functions
-- Run this AFTER the minimal schema is working
...
-- Daily activity summary (simple version without materialized view)
